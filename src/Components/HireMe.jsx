...
//               <div 
//                 key={index}
//                 className="group flex flex-col items-center text-center bg-[#9b586d94] p-6 border-2 border-white/60 rounded-2xl transition-all duration-300 ease-out hover:bg-white hover:border-[#b4647d]/20 hover:shadow-[0_15px_30px_-10px_rgba(180,100,125,0.2)] hover:-translate-y-1.5"
//               >
//                 {/* Icon Box */}
...
//                 {/* Title */}
//                 <h3 className="text-sm font-bold text-white mb-2 px-2">
//                   {item.title}
//                 </h3>
                
//                 {/* Description */}
//                 <p className="text-[12px] text-white/75 font-medium leading-relaxed max-w-[200px]">
//                   {item.description}
//                 </p>
//               </div>
//             ))}
